...
#     'integrate(cos(x)**2*sin(x)+3x^5, x)',
...
#     'integrate((3*x+2)/(x**2+2*x+3), x)',
#     'integrate(acos(x)/sqrt(1-x**2), x)',
#     'integrate(coth(x)/x, x)',
#     'integrate(exp(x)/(1+exp(-x)), x)',
#     'integrate(x*exp(-x)/(1+exp(-x)), x)',
#     'integrate((x+2)**2/(x**2+4), x)',
...
#     'integrate(exp(x)*sqrt(1+exp(10*x)), x)',
#     'integrate(exp(x)/sqrt(1+exp(2*x)), x)',
#     'integrate((x+2)/(x**2+2*x+2), x)',
#     'integrate(exp(-x**2), x)',
#     'integrate(sin(x)**2*cos(x), x)',
#     'integrate(14*sin(x)*cos(x)**2, x)',
#     'integrate(x*sin(x)**2, x)',
...
#     unique_questions = set(TEST_QUESTIONS)

#     # Calculate the number of duplicates
#     num_duplicates = len(TEST_QUESTIONS) - len(unique_questions)

#     print(f"There are {num_duplicates} duplicate questions in the list.")

#     # Find the duplicate questions
#     duplicate_questions = [q for q in TEST_QUESTIONS if TEST_QUESTIONS.count(q) > 1]
